...
- **Restricted Chrome Pages:** For pages where content script injection is impossible (`chrome://`, the Chrome Web Store, or the internal browser PDF viewer), the toolbar popup prompts users to paste their sentence directly.
