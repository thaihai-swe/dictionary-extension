  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        heading: ['Inter', '-apple-system', 'BlinkMacSystemFont', '"SF Pro Display"', '"Segoe UI"', 'Roboto', 'Helvetica', 'Arial', 'sans-serif'],
      ...
      boxShadow: {
        ...
        'card-elevated': 'var(--shadow-elevated, 0 12px 36px -4px rgba(0, 0, 0, 0.12), 0 4px 12px -2px rgba(0, 0, 0, 0.06))',
        'glow-accent': '0 0 24px -2px rgba(20, 184, 166, 0.4)',
        'glow-subtle': '0 0 16px -2px rgba(20, 184, 166, 0.2)',
