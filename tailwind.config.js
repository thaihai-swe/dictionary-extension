    ...
    extend: {
      colors: {
        ...
        accent: {
          ...
          hover: 'var(--color-primary-hover, #15803d)',
          light: 'var(--color-primary-light, rgba(22, 163, 74, 0.12))',
          subtle: 'var(--color-primary-light, rgba(22, 163, 74, 0.08))',
        },
      },
      textColor: {
      ...
      boxShadow: {
        'glow-gold': '0 0 24px -2px rgba(34, 197, 94, 0.32)',
        'glow-teal': '0 0 24px -2px rgba(22, 163, 74, 0.28)',
