      ...
      <div className="flex flex-wrap gap-1.5">
        {DEMO_PRESETS.map((preset) => (
          <button
            ...
            className="inline-flex items-center gap-1.5 min-h-8 px-2.5 rounded-full border border-border bg-muted/40 hover:bg-teal-500/10 hover:border-teal-500/40 text-content-secondary hover:text-content transition-colors cursor-pointer"
          >
