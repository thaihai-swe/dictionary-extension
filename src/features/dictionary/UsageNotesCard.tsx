...
export const UsageNotesCard: React.FC<UsageNotesCardProps> = ({ notes, warnings, pairs }) => {
  ...
  return (
    <div className="rounded-2xl border border-amber-500/30 bg-amber-500/8 p-4 space-y-2 shadow-xs">
      ...
      <ul className="space-y-1.5 text-[14px] leading-relaxed text-content-secondary">
